...
void initTiles(std::unordered_map<int, std::string> &tiles)
{
    ...
    tiles[CATTLE] = "assets/assets/terrain/cattle.png";
    ...
    tiles[GEOSHIELD] = "assets/assets/terrain/geoshield.png";
    ...
    tiles[GUNPOWDER] = "assets/assets/terrain/gunpowder.png";
    ...
    tiles[meat]      = "assets/assets/city/meat.png";
    ...
    tiles[gunpowder] = "assets/assets/city/gunpowder.png";
...
void initResources(std::unordered_map<int, std::vector<int>> &resourcexbioma)
{
    ...
    resourcexbioma[FOREST]     = {GAME,GUNPOWDER,DOE};
    resourcexbioma[GRASSLAND]  = {MARBLE,CARBON,IRON,COPPER,GOLD,DOE,GAME,HORSE,CATTLE, COTTON,TOBACCO,GEOSHIELD};
    resourcexbioma[HILLS]      = {MARBLE,CARBON,IRON,COPPER,GOLD,GEMS,OIL,GRAPES, GEOSHIELD};
    resourcexbioma[JUNGLE]     = {IRON,GOLD,GEMS,SILK,SPICES, GUNPOWDER,SUGAR, OIL};
    resourcexbioma[MOUNTAINS]  = {MARBLE,CARBON,IRON,COPPER,GOLD,SILVER,GEMS,OIL,URANIUM,ALUMINIUM,GEOSHIELD};
    resourcexbioma[PLAINS]     = {DOE,GAME,HORSE,OIL,GEOSHIELD, CATTLE, ELEPHANTS};
    resourcexbioma[RIVER]      = {FISH};
    resourcexbioma[SWAMP]      = {GOLD,GEMS,HELIUM_3,OIL,GUNPOWDER};
...
void initCommodities(std::unordered_map<int, int> &commodityxresource)
{
    ...
    commodityxresource[CATTLE]    = meat;
    ...
    commodityxresource[GUNPOWDER] = gunpowder;
