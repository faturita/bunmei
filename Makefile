...
SSM = src/improvements.cpp src/commandline.cpp src/diplomacy.cpp src/math/vec3f.cpp src/math/yamathutil.cpp src/tiles.cpp src/resources.cpp src/engine.cpp src/City.cpp $(shell ls src/units/*.cpp) $(shell ls src/buildings/*.cpp)  src/simulate.cpp
OSSM = $(SSM:.cpp=.o)
